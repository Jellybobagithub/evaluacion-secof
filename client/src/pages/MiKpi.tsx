...
const TIPO_CONFIG: Record<string, { label: string; emoji: string; criterios: Record<string, string> }> = {
  ...
  preparacion: { label: "Preparaciones",       emoji: "🧋", criterios: { receta: "Siguió la receta", tiempo: "Tiempo de preparación", temperatura: "Temperatura correcta", presentacion: "Presentación del producto" }},
