...
import { Building2, PlusCircle, MapPin, User, ClipboardList, Pencil, Trash2 } from "lucide-react";
      ...
      {activasSucursales.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
          {activasSucursales.map(s => {
            ...
            return (
              <Card key={s.id} className="border-0 shadow-sm hover:shadow-md transition-shadow cursor-pointer bg-white" onClick={() => setLocation(`/sucursales/${s.id}`)}>
