...
import { Building2, PlusCircle, MapPin, User, ClipboardList, Pencil, Trash2, Phone } from "lucide-react";
          ...
          {activasSucursales.map(s => {
            ...
            return (
              <Card key={s.id} className="border-0 shadow-sm hover:shadow-md transition-shadow cursor-pointer bg-white overflow-hidden" onClick={() => setLocation(`/sucursales/${s.id}`)}>
                {/* Banner de color */}
                <div className="h-20 w-full bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center">
